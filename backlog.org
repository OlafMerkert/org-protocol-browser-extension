...
+ large square button
*** DONE polish styles
** IN-PROGRESS Keyboard shortcuts
...
*** TODO add commands with keybinding to manifest
*** TODO adjust build to create background script
*** TODO handle commands in background script
