...
*** DONE license
*** DONE readme
** REFINE package the web-extension
As a user, I would like to install the extension like any other addon.

*** TODO generate html file for popup automatically, or move to dist?
*** TODO use target as output directory
*** TODO use web-ext build for packaging
